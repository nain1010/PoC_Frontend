...
export interface LayoutState {
  ...
  layoutThemeType: LAYOUT_THEME.DEFAULT | LAYOUT_THEME.MODERN;
  layoutThemeColorType: LAYOUT_THEME_COLOR.DEFAULT | LAYOUT_THEME_COLOR.PURPLE;
...
const storedConfig = getLocalStorage("layout-config") || {};

export const initialState: LayoutState = {
  layoutType: storedConfig.layoutType || LAYOUT_TYPES.VERTICAL,
  layoutThemeType: storedConfig.layoutThemeType || LAYOUT_THEME.DEFAULT,
  layoutThemeColorType: storedConfig.layoutThemeColorType || LAYOUT_THEME_COLOR.DEFAULT,
  layoutModeType: storedConfig.layoutModeType || LAYOUT_MODE_TYPES.LIGHTMODE,
  leftSidebarType: storedConfig.leftSidebarType || LAYOUT_SIDEBAR_TYPES.DARK,
  layoutWidthType: storedConfig.layoutWidthType || LAYOUT_WIDTH_TYPES.FLUID,
  layoutPositionType: storedConfig.layoutPositionType || LAYOUT_POSITION_TYPES.FIXED,
  topbarThemeType: storedConfig.topbarThemeType || LAYOUT_TOPBAR_THEME_TYPES.LIGHT,
  leftsidbarSizeType: storedConfig.leftsidbarSizeType || LEFT_SIDEBAR_SIZE_TYPES.DEFAULT,
  leftSidebarViewType: storedConfig.leftSidebarViewType || LEFT_SIDEBAR_VIEW_TYPES.DEFAULT,
  leftSidebarImageType: storedConfig.leftSidebarImageType || LEFT_SIDEBAR_IMAGE_TYPES.NONE,
  preloader: storedConfig.preloader || PERLOADER_TYPES.DISABLE,
  sidebarVisibilitytype: storedConfig.sidebarVisibilitytype || SIDEBAR_VISIBILITY_TYPES.SHOW
};
